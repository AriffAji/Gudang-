...
<body class="bg-gray-100 text-gray-800">
      ...
      <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://www.politanipyk.ac.id/" class="flex items-center space-x-3 rtl:space-x-reverse">
              <img src="https://res.cloudinary.com/dvul7dq3b/image/upload/v1755843240/logowebp_bqssky.webp" class="h-8" alt="Flowbite Logo" />
              <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PPNP</span>
          </a>
    ...
    <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {{ date('Y') }} Sistem Inventaris - All rights reserved.</span>
        </div>
    </footer>
